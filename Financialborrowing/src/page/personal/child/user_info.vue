        ...
        <div class="panel panel-default">
            ...
            <form id="userInfoForm" class="form-horizontal" action="/userInfo_save.html" method="post"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" name="phone" style="width: 250px;" class="form-control" value="" v-model="user.phone"/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" name="tel" style="width: 250px;" class="form-control" value="" v-model="user.phone"/>
                    </div>
                </div>
